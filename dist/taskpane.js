...
async function openJsonDialog(jsonString) {
  Office.context.ui.displayDialogAsync(location.origin + '/taskpane/dialog.html?json=' + encodeURIComponent(jsonString), {
    height: 50,
    width: 50
  }, result => {
